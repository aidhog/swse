...
public class AggregateTripleMaxRanksTest extends TestCase{
	...
	private static final Node[][] AGG_DATA = {
		new Node[]{ new BNode("a"), new BNode("b"), new BNode("c"), new Literal("0.3")},
		new Node[]{ new BNode("c"), new BNode("d"), new BNode("e"), new Literal("0.4")},
		new Node[]{ new BNode("c"), new BNode("d"), new BNode("f"), new Literal("0.5")},
		new Node[]{ new BNode("c"), new BNode("d"), new BNode("g"), new Literal("0.2")},
		new Node[]{ new BNode("h"), new BNode("k"), new BNode("m"), new Literal("0.3")},
	};
	...
	public void testAggregateTriples() throws Exception{
		...
		AggregateTripleMaxRanksIterator atr = new AggregateTripleMaxRanksIterator(sorted.iterator());
