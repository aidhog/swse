...
public class RMIBenchCoordinateTest extends TestCase{
	
	private static final String OUT = "testdata/benchc%/";
	...
	public static void main(String[] args) throws Exception{
		...
		RunRemoteBench.runBenchCoordinate(IN, GZIP, servers, OUT);
	}
}
