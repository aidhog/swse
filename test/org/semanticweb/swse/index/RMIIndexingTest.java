...
import org.semanticweb.swse.cli.RunRemoteIndexing;
import org.semanticweb.swse.index.RMIIndexerConstants;
import org.semanticweb.swse.index.RMIIndexerServer;

import junit.framework.TestCase;

public class RMIIndexingTest extends TestCase{
	
	private static final String OUT = "testdata/index%/";
	...
	public static void main(String[] args) throws Exception{
		...
		RunRemoteIndexing.runRemoteIndexing(L_IN, GZ_L_IN, R_IN, GZ_R_IN, servers, OUT);
	}
}
