...
import org.semanticweb.swse.ann.repair.RMIAnnRepairServer;
 ...
 * @author aidhog
 */
public class StartRemoteRepairServer {
	...
	public static void main(String args[]) throws IOException, ClassNotFoundException, AlreadyBoundException{
		...
		int port = RMIAnnRepairConstants.DEFAULT_RMI_PORT;
		if (cmd.hasOption("p")) {
		...
		RMIAnnRepairServer.startRMIServer(hostname, port, RMIAnnRepairConstants.DEFAULT_STUB_NAME);
