 ...
 * @author aidhog
 */
public class StartRemoteReasonerServer {
	...
	public static void main(String args[]) throws IOException, ClassNotFoundException, AlreadyBoundException{
		...
		int port = RMIAnnReasonerConstants.DEFAULT_RMI_PORT;
		if (cmd.hasOption("p")) {
		...
		RMIAnnReasonerServer.startRMIServer(hostname, port, RMIAnnReasonerConstants.DEFAULT_STUB_NAME);
