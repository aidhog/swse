 ...
 * @author aidhog
 */
public class StartRemoteRankingServer {
	...
	public static void main(String args[]) throws IOException, ClassNotFoundException, AlreadyBoundException{
		...
		int port = RMIAnnRankingConstants.DEFAULT_RMI_PORT;
		if (cmd.hasOption("p")) {
		...
		RMIAnnRankingServer.startRMIServer(hostname, port, RMIAnnRankingConstants.DEFAULT_STUB_NAME);
