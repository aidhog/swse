 ...
 * @author aidhog
 */
public class StartRemoteAggregationServer {
	...
	public static void main(String args[]) throws IOException, ClassNotFoundException, AlreadyBoundException{
		...
		int port = RMIAnnAggregateConstants.DEFAULT_RMI_PORT;
		if (cmd.hasOption("p")) {
		...
		RMIAnnAggregateServer.startRMIServer(hostname, port, RMIAnnAggregateConstants.DEFAULT_STUB_NAME);
