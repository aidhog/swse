 ...
 * @author aidhog
 */
public class StartRemoteInconsistencyServer {
	...
	public static void main(String args[]) throws IOException, ClassNotFoundException, AlreadyBoundException{
		...
		int port = RMIAnnInconConstants.DEFAULT_RMI_PORT;
		if (cmd.hasOption("p")) {
		...
		RMIAnnInconServer.startRMIServer(hostname, port, RMIAnnInconConstants.DEFAULT_STUB_NAME);
