 ...
 * @author Aidan Hogan
 */
public class EconsMain {
	private static final String USAGE = "usage: org.semanticweb.rmi.cli.Main <utility> [options...]";
	private static final String PREFIX = "org.semanticweb.rmi.econs.cli.";
	...
	public static void main(String[] args) {
		try {
			if (args.length < 1) {
				...
				sb.append("\n\tRunRemoteStats  Run distributed stats for consolidation");
				sb.append("\n\tStartRemoteStatsServer  Set up RMI-controllable stats server for consolidation");
