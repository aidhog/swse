 ...
 * @author aidhog
 */
public class StartRemoteQueryServer {
	...
	public static void main(String args[]) throws IOException, ClassNotFoundException, AlreadyBoundException{
		...
		int port = RMIQueryConstants.DEFAULT_RMI_PORT;
		if (cmd.hasOption("p")) {
		...
		RMIQueryServer.startRMIServer(hostname, port, RMIQueryConstants.DEFAULT_STUB_NAME);
