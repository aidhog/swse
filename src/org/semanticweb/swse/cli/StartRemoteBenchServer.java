 ...
 * @author aidhog
 */
public class StartRemoteBenchServer {
	...
	public static void main(String args[]) throws IOException, ClassNotFoundException, AlreadyBoundException{
		...
		int port = RMIBenchConstants.DEFAULT_RMI_PORT;
		if (cmd.hasOption("p")) {
		...
		RMIBenchServer.startRMIServer(hostname, port, RMIBenchConstants.DEFAULT_STUB_NAME);
