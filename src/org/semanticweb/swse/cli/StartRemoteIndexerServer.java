 ...
 * @author aidhog
 */
public class StartRemoteIndexerServer {
	...
	public static void main(String args[]) throws IOException, ClassNotFoundException, AlreadyBoundException{
		...
		int port = RMIIndexerConstants.DEFAULT_RMI_PORT;
		if (cmd.hasOption("p")) {
		...
		RMIIndexerServer.startRMIServer(hostname, port, RMIIndexerConstants.DEFAULT_STUB_NAME);
