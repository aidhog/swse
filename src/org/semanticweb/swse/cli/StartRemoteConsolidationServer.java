...
/**
 * Main method to setup a consolidation service which can be run via RMI.
 * 
 * @author aidhog
 */
public class StartRemoteConsolidationServer {
	...
	public static void main(String args[]) throws IOException, ClassNotFoundException, AlreadyBoundException{
		...
		int port = RMIConsolidationConstants.DEFAULT_RMI_PORT;
		if (cmd.hasOption("p")) {
		...
		RMIConsolidationServer.startRMIServer(hostname, port, RMIConsolidationConstants.DEFAULT_STUB_NAME);
