 ...
 * @author aidhog
 */
public class StartRemoteFileServer {
	...
	public static void main(String args[]) throws IOException, ClassNotFoundException, AlreadyBoundException{
		...
		int port = RMIFileConstants.DEFAULT_RMI_PORT;
		if (cmd.hasOption("p")) {
		...
		RMIFileServer.startRMIServer(hostname, port, RMIFileConstants.DEFAULT_STUB_NAME);
