 ...
 * @author aidhog
 */
public class StartRemoteTaskMngrServer {
	...
	public static void main(String args[]) throws IOException, ClassNotFoundException, AlreadyBoundException{
		...
		int port = RMITaskMngrConstants.DEFAULT_RMI_PORT;
		if (cmd.hasOption("p")) {
		...
		RMITaskMngrServer.startRMIServer(hostname, port, RMITaskMngrConstants.DEFAULT_STUB_NAME);
