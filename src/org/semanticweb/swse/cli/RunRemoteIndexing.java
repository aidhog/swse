...
import org.semanticweb.swse.index.master.MasterIndexer;
 ...
 * @author aidhog
 */
public class RunRemoteIndexing {
	private final static Logger _log = Logger.getLogger(RunRemoteIndexing.class.getSimpleName());
