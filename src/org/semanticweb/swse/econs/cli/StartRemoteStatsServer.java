 ...
 * @author aidhog
 */
public class StartRemoteStatsServer {
	...
	public static void main(String args[]) throws IOException, ClassNotFoundException, AlreadyBoundException{
		...
		int port = RMIEconsStatsConstants.DEFAULT_RMI_PORT;
		if (cmd.hasOption("p")) {
		...
		RMIEconsStatsServer.startRMIServer(hostname, port, RMIEconsStatsConstants.DEFAULT_STUB_NAME);
