 ...
 * @author aidhog
 */
public class StartRemoteInconsServer {
	...
	public static void main(String args[]) throws IOException, ClassNotFoundException, AlreadyBoundException{
		...
		int port = RMIEconsInconConstants.DEFAULT_RMI_PORT;
		if (cmd.hasOption("p")) {
		...
		RMIEconsInconServer.startRMIServer(hostname, port, RMIEconsInconConstants.DEFAULT_STUB_NAME);
