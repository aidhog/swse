 ...
 * @author aidhog
 */
public class StartRemoteSimServer {
	...
	public static void main(String args[]) throws IOException, ClassNotFoundException, AlreadyBoundException{
		...
		int port = RMIEconsSimConstants.DEFAULT_RMI_PORT;
		if (cmd.hasOption("p")) {
		...
		RMIEconsSimServer.startRMIServer(hostname, port, RMIEconsSimConstants.DEFAULT_STUB_NAME);
