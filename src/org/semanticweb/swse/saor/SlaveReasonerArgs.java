...
public class SlaveReasonerArgs extends SlaveArgs {
	/**
	 * 
	 */
	...
	private boolean _gzOutT = MasterArgs.DEFAULT_GZ_IN;
	
	private String _outReasoned;
	private boolean _gzOutR = MasterArgs.DEFAULT_GZ_IN;
	...
	public SlaveReasonerArgs(String inT, String inA, String redirs, String outTbox, String outReasoned){
		_outTbox = outTbox;
	...
	public SlaveReasonerArgs instantiate(int server) {
		...
		SlaveReasonerArgs sca = new SlaveReasonerArgs(inT, inA, _redirs, outt, outr);
